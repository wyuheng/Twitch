package com.roadtomastery.project;
...
public class ApplicationConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("com.roadtomastery.project.entity.db");
    ...
    public DataSource dataSource() {
        String RDS_ENDPOINT = "database-1.cn6udbzykwcj.us-east-2.rds.amazonaws.com";
